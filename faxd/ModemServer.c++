...
ModemServer::getModemLine(char rbuf[], u_int bufSize, long ms)
{
	...
	traceStatus(FAXTRACE_MODEMCOM, "--> [%d:%s]", cc, isprintable ? rbuf : "<non-printable data>");
    return (cc);
}
