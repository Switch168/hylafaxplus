...
public:
    ...
    fxStr	class1PhaseBRecvTimeoutCmd; // cmd to issue after each Phase B recv timeout
    ...
    u_int	class1ExpectedPageSize;	// expected page size for non-ECM Phase D waiting
    ...
    bool	class1FullDuplexTrainingSync;	// switch to full duplex during difficult training periods
    bool	class1FRHNeedsReset;	// modem's +FRH=3 needs to be reset sometimes
					// for class 2 and 2.0:
